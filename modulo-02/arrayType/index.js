...
let frutas01 = ["abacaxi", "laranja", "maca", "melancia", "manga"];
...
let idiomas = ["Portugues", "Ingles", "Frances", "Russo"];
console.log(idiomas);
idiomas.push("Mandarin");
console.log(idiomas);
// Exemplo 04 - Identificar tamanho do Array - metodo 'length':
let idiomas00 = ["Portugues", "Ingles", "Frances", "Italiano"];
...
let linguagensArray = new Array("javascript", "java", "php", "rust");
function funcaoLinguages(linguages) {
